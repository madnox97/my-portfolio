...
// Helper function to get all projects in original order
export const getAllVideoProjects = (): VideoProject[] => {
  return allVideoProjects; // Return in original order without sorting
};

// Helper function to get projects by category in original order
export const getVideoProjectsByCategory = (
  ...
  return filteredProjects; // Return in original order without sorting
};
...
// Helper function to format duration from YouTube API (PT4M13S format to MM:SS)
