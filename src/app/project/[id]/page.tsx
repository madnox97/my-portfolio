...
export default function ProjectPage() {
  ...
  const isLocalVideo = project.video_type === "local";
  const embedUrl = isLocalVideo ? null : getYouTubeEmbedUrl(project.video_link);
        ...
        >
          <GlassmorphismCard className="p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {isLocalVideo ? (
                // For local videos, show download or play button
                <Button 
                  onClick={() => setShowVideo(true)}
                ...
                // For YouTube videos, show external link
