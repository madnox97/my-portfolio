                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-400 text-sm">Email</p>
                                         <a
                       href="mailto:koraganjimukesh@gmail.com?subject=Need%20Video%20editor"
                       className="text-white hover:text-blue-400 transition-colors"
                       onClick={(e) => {
                         // Fallback: if mailto doesn't work, copy to clipboard
                         if (!navigator.userAgent.includes('mailto:')) {
                           e.preventDefault();
                           navigator.clipboard.writeText('koraganjimukesh@gmail.com');
                           // You could add a toast notification here
                         }
                       }}
                     >
                       koraganjimukesh@gmail.com
                     </a>
                  </div>
                </div>
